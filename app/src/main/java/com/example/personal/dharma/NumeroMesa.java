...
public class NumeroMesa extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adaptador = new ArrayAdapter<>(NumeroMesa.this, android.R.layout.simple_spinner_item, numerosMesas);
        ...
        //Insertar número de mesa a la base de datos
        manager = new DataBaseManager(this);
        manager.insertarMesa(numeroDeMesaIngresado);
